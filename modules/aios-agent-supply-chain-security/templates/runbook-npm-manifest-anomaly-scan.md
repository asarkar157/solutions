...
7. Compute phantom set: declared minus (imported union config-referenced union build-only)
8. Assess risk: recently added plus new maintainer means **HIGH**; old plus unused means **MEDIUM**
