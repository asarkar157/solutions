---
layout: page
title: TR deployment profile
permalink: tr-deployment-profile/
nav_order: 7
---

# TR / enterprise deployment profile

Maps the TR Post-PoC architecture to **this repository** and **platform repos**. Use this when wiring a single-tenant Guild stack for CloudFormation governance + optional Terraform module quality.
...
## Webhook ingress (TR CI / drift Lambda)
